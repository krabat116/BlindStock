...
type AddStockModalProps = {
  ...
  onClose: () => void
  onSave: (itemId: number, quantity: number, note: string) => Promise<void>
}
                  ...
                  <tr className="bg-gray-50 text-sm text-gray-700">
                    ...
                    <td className="px-4 py-3">
                      <input
                        ...
                        className="w-32 rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 outline-none focus:border-blue-500"
                      />
                    </td>
